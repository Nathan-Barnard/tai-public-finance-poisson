...
def main() -> int:
    ...
    for c in result.candidates:
        ...
        admissible = candidate_is_admissible(diag, tolerances.get("independent_tolerance", 1.0e-8))
    ...
    report = {
        ...
        "run_fingerprint": run_fingerprint(primitives, tolerances, {"k_grid_points": k_grid_points, "marks": ["L", "H"], "worker": "W1_binary_mark_rank_one_baseline"}),
